		...
		<div class="ajaxJoin-con">
			...
			<div class="join-form">
				<ul>
					...
					<li><input type="radio" name="여성" id="userGender" value="여성"/>여성
					<input type="radio" name="남성" class="userGender" value="남성"/>남성
					<input type="radio" name="비밀" class="userGender" value="비밀" checked/>비밀</li>
					<li><label for="Address">ADDRESS</label></li>
					<li><input type="text" name="userAdd" id="userAdd" /></li>
