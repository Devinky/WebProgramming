					...
					<form action="memberInsert.do" method="post" id="join">
						...
						<table>
							...
							<tr>
								...
								<td><input type="radio" name="gender" id="genderfemale" value="여성">여성
									<input type="radio" name="gender" id="gendermale" value="남성">남성
									<input type="radio" name="gender" id="gendersecret" value="비밀 "checked>비밀
								</td>
							</tr>
							<tr>
								<td><label for="hobbys">취미 </label></td>
								<td><input type="checkbox" name="hobbys" id="read" value="독서">독서
									<input type="checkbox" name="hobbys" id="music" value="음악감상">음악감상 <input
									type="checkbox" name="hobbys" id="movie" value="영화관람">영화관람 <input
							...
							<tr class="lastTr">
								...
								<input type="button" value="눌러봐" onclick="alert('🎅메리 크리스마스~')">
