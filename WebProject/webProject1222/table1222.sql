...
insert into login1222(userId,userPw,gender,hobbys,city,memo) values('m1','1111','남성','게임','서울','자기소개1');
insert into login1222(userId,userPw,gender,hobbys,city,memo) values('m2','2222','남성','음악감상','부산','자기소개2');
insert into login1222(userId,userPw,gender,hobbys,city,memo) values('m3','3333','여성','영화관람','경기','자기소개3');
